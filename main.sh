...
# u-11 /etc/syslog.conf file owner authority setiing 
...
# u-13 SUID, SGID, Setiing file check
...
# u-14 User, System Startup file & Environment file owner and authority Settings
...
# u-15 world writealble file check
...
# u-17 Do not use $HOME/.rhosts, hosts.equiv
...
# u-18 connection ip and port limit 접속 IP 및 포트 제한
check_tcp_wrapper() {
...
# u-22 cron file owner and permissions
...
# u-23 Dos attack service disabled
...
# u-29 tftp, talk service disable
...
# u-32 Normal User Sendmail prevent execution
...
# u-34 DNS Zone Transfer Settings
...
# u-35 webservice directory delete listing
...
# u-36 Webservice web process Permission restrictions
...
# u-37 Webservice parent directory Forbidden
...
# u-38 Webservice Delete Remove unnecessary files
...
# u-40 Limit Webserver File upload and download
...
# u-47, u-48 패스워드 최대 사용기간 설정 및 패스워드 최소 사용기간 설정
